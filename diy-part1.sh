...
sed -i 's/KERNEL_PATCHVER:=5.4/KERNEL_PATCHVER:=4.19/g' ./target/linux/sunxi/Makefile
sed -i 's/KERNEL_TESTING_PATCHVER:=5.4/KERNEL_TESTING_PATCHVER:=4.19/g' ./target/linux/sunxi/Makefile
...
git clone --depth 1 https://github.com/project-lede/luci-app-godproxy.git package/luci-app-godproxy
...
git clone --depth 1 https://github.com/BCYDTZ/luci-app-UUGameAcc.git package/luci-app-UUGameAcc
# git clone --depth 1 https://github.com/ITdesk01/jd_openwrt_script.git package/jd_openwrt_script
